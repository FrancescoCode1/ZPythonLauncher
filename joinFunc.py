...
#def joinServ(srv):
#    join = requests.post(url=urlc + srv + url)
#    print("Joining Server please wait")


#if __name__ == '__main__':
#    main()
    #r"http: // localhost: 5080 / ZLO / run?game = Z.BF3 & cmd = "+params2+data2
    #"http://localhost:5080/ZLO/run?game=Z.BF3&cmd=-webMode%20MP%20-Origin_NoAppFocus%20-loginToken%20WAHAHA_IMMA_ZLO_TOKEN%20-requestState%20State_ClaimReservation%20-requestStateParams%20%22%3Cdata%20putinsquad%3D%5C%22true%5C%22%20gameid%3D%5C%226%5C%22%20role%3D%5C%22soldier%5C%22%20personaref%3D%5C%22%25ZID%25%5C%22%20levelmode%3D%5C%22mp%5C%22%20logintoken%3D%5C%22WAHAHA_IMMA_ZLO_TOKEN%5C%22%3E%3C%2Fdata%3E%22"
